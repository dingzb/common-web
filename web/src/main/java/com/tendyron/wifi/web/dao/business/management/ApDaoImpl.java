package com.tendyron.wifi.web.dao.business.management;

import com.tendyron.wifi.web.dao.BaseDaoImpl;
import com.tendyron.wifi.web.entity.business.management.ApEntity;
import com.tendyron.wifi.web.query.BaseQuery;
import com.tendyron.wifi.web.query.business.management.ApQuery;
...
//				params.put("placeName", "%" + URLDecoder.decode(apQuery.getPlaceName(),"UTF-8") + "%");
		...
		if (StringTools.hasText(apQuery.getPlaceId())) {
		...
		if(StringTools.hasText(apQuery.getApproveStatus())){
	...
	public List<Object[]> getByConfigSchedule(ApQuery query) {
		...
		if(StringTools.hasText(query.getCode())){
			sb.append(" /*code过滤条件*/"
